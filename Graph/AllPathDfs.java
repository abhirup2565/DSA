...
public class AllPathDfs {
    public static void main(String[] args) {
        ...
        public static void haspath(ArrayList<Edge>[]graph,int src,int dst,boolean[]visited,String ans)
        {
            if(src==dst)
            {
                System.out.println(ans+String.valueOf(src));
                return;
            }
            visited[src]=true;
            for(Edge edge:graph[src])
            {
                ...
                {
                    haspath(graph, edge.nbr, dst,visited,ans+String.valueOf(src));
                } 
            }
            visited[src]=false;
            return;
